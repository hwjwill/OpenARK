...
void Viewer::Run()
{
    ...
    pangolin::Var<bool> menuSegment("menu.Seg & Gen",false,false);
    ...
    pangolin::View& d_cam = pangolin::CreateDisplay()
            .SetBounds(0.0, 1.0, pangolin::Attach::Pix(175), 0.5, mImageWidth / mImageHeight)
            .SetHandler(new pangolin::Handler3D(s_cam));

    pangolin::View &p_cam = pangolin::CreateDisplay()
            .SetBounds(0.0, 1.0, 0.5, 1.0, mImageWidth / mImageHeight)
            .SetHandler(new pangolin::Handler3D(s_cam));
    ...
    while(1)
    {
        ...
        p_cam.Activate(s_cam);
        mpPointModelDrawer->drawModel();
